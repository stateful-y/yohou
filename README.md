...
![Yohou Screenshot](https://raw.githubusercontent.com/stateful-y/yohou/main/docs/assets/screenshot_dark.png)

[Optional: Add version compatibility note]
<!-- Example: Currently, Yohou supports Python 3.11+, and [dependency] versions X.Y.z -->
