...
def _search_forecaster_has(attr):
    ...
    decorator to ensure predict/update methods are only available when refit=True and
    ...
    - For other attributes (methods like "reset", "update"), it checks attribute
...
def _yield_masked_array_for_each_param(candidate_params):
    ...
    l1_ratio: [0.5 0.7 --]  # Last entry masked
...
class BaseSearchCV(BaseForecaster, MetaEstimatorMixin, metaclass=ABCMeta):
    ...
    Important members are fit, predict, predict_interval, update, and score.
    ...
    def fit(self, y, X=None, forecasting_horizon=1, **params):
        ...
        **params : dict of str -> object
        ...
        update : Update the best forecaster with new observations.
    ...
    def update_predict(
        ...
        **params : dict
        ...
        return self.best_forecaster_.update_predict(
            y, X, forecasting_horizon, panel_group_names, stride, predict_transformed, **params
        )

    @available_if(_search_forecaster_has("update_predict_interval"))
    def update_predict_interval(self, y, X=None, coverage_rates=None, panel_group_names=None, **params):
        ...
        **params : dict
        ...
        return self.best_forecaster_.update_predict_interval(y, X, coverage_rates, panel_group_names, **params)
...
class GridSearchCV(BaseSearchCV):
    ...
    It also implements "predict", "predict_interval", "update", "reset",
    "update_predict", and "update_predict_interval" if the underlying
...
class RandomizedSearchCV(BaseSearchCV):
    ...
    Read more in the :ref:`User Guide <yohou_randomized_search>`.
