...
class ColumnTransformer(BaseTransformer, _BaseComposition):
    ...
    def _transformers(self) -> list[tuple[str, Any, Any]]:
        ...
        """
        return sklearn_ColumnTransformer._transformers.fget(self)  # type: ignore[attr-defined, invalid-argument-type]  # ty:ignore[invalid-argument-type]
    ...
    def _iter(
        ...
        return sklearn_ColumnTransformer._iter(
            self,  # type: ignore[arg-type, invalid-argument-type]  # ty:ignore[invalid-argument-type]
            fitted=fitted,
    ...
    def _update_fitted_transformers(self, transformers: Any) -> None:
        ...
        sklearn_ColumnTransformer._update_fitted_transformers(self, transformers)  # type: ignore[arg-type, invalid-argument-type]  # ty:ignore[invalid-argument-type]
    ...
    def get_feature_names_out(self, input_features: list[str] | None = None) -> list[str]:
        ...
        for name, trans, columns in self.transformers_:  # type: ignore[attr-defined, unresolved-attribute]  # ty:ignore[unresolved-attribute]
    ...
    def _get_remainder_cols(self, indices: Any) -> Any:
        ...
        return sklearn_ColumnTransformer._get_remainder_cols(self, indices)  # type: ignore[arg-type, invalid-argument-type]  # ty:ignore[invalid-argument-type]
    ...
    def _get_remainder_cols_dtype(self) -> Any:
        ...
        """
        return sklearn_ColumnTransformer._get_remainder_cols_dtype(self)  # type: ignore[arg-type, invalid-argument-type]  # ty:ignore[invalid-argument-type]
    ...
    def _sk_visual_block_(self) -> Any:
        ...
        """
        return sklearn_ColumnTransformer._sk_visual_block_(self)  # type: ignore[arg-type, invalid-argument-type]  # ty:ignore[invalid-argument-type]
    ...
    def _validate_remainder(self, X: Any) -> None:
        ...
        sklearn_ColumnTransformer._validate_remainder(self, X)  # type: ignore[arg-type, invalid-argument-type]  # ty:ignore[invalid-argument-type]
    ...
    def _validate_column_callables(self, X: Any) -> None:
        ...
        sklearn_ColumnTransformer._validate_column_callables(self, X)  # type: ignore[arg-type, invalid-argument-type]  # ty:ignore[invalid-argument-type]
    ...
    def _record_output_indices(self, Xs: Any) -> None:
        ...
        sklearn_ColumnTransformer._record_output_indices(self, Xs)  # type: ignore[arg-type, invalid-argument-type]  # ty:ignore[invalid-argument-type]
    ...
    def transform(self, X: pl.DataFrame, **params: Any) -> pl.DataFrame:
        ...
        **params : dict, default=None
        ...
        if fit_dataframe_and_transform_dataframe:
            ...
            non_dropped_indices = [
                ind
                for name, ind in self._transformer_to_input_indices.items()  # type: ignore[attr-defined, unresolved-attribute]  # ty:ignore[unresolved-attribute]
            ...
            self._check_n_features(X_no_time, reset=False)  # type: ignore[attr-defined, unresolved-attribute]  # ty:ignore[unresolved-attribute]
