...
def exponential_decay_weight(
    ...
    if isinstance(half_life, numbers.Number):
        from datetime import timedelta
    ...
    def _weight_fn(time: pl.Series) -> pl.Series:
        ...
        return pl.Series(weights, dtype=pl.Float64)
...
def linear_decay_weight(
    ...
    def _weight_fn(time: pl.Series) -> pl.Series:
        ...
        # Compute rank (0 = oldest, n-1 = newest)
        ...
        if max_steps is None:
            ...
            weights = np.maximum(0, (ranks - (n - max_steps - 1)) / max_steps)
...
def seasonal_emphasis_weight(
    ...
    >>> weights = weight_fn(times)
    >>> weights  # Tuesdays (positions 1, 3) emphasized
    shape: (4,)
    Series: '' [f64]
    [
        1.0
...
def compose_weights(
    ...
    *weight_fns : Callable[[pl.Series], pl.Series]
    ...
    ...     exponential_decay_weight(half_life=2),
    ...     seasonal_emphasis_weight(seasonality=2, emphasis=1.5)
    ... )
    >>> weights = weight_fn(times)
