...
class PatternSeasonalityForecaster(_BaseSeasonalityForecaster):
    ...
    def __init__(
        ...
        super().__init__(seasonality=seasonality, target_transformer=target_transformer, model_panel=model_panel)
        self.method = method
    ...
    def _extract_pattern(self, y_t: pl.DataFrame | dict[str, pl.DataFrame]) -> pl.DataFrame | dict[str, pl.DataFrame]:
