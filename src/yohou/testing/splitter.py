    ...
    if splitter_tags.requires_data_for_n_splits:
        ...
        try:
            ...
            raise AssertionError(
                "Splitter declares requires_data_for_n_splits=True but get_n_splits(y=None) did not raise ValueError"
            )
        except ValueError:
            pass  # Expected
    else:
        ...
        try:
            ...
            raise AssertionError(
                f"Splitter declares requires_data_for_n_splits=False but get_n_splits(y=None) raised ValueError: {e}"
            ) from e
