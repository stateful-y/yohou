...
def check_search_update_delegates(
    ...
    if isinstance(initial_observed_time, dict):
        ...
        assert updated_observed_time > initial_observed_time, (
            f"observed_time should increase after update, got {initial_observed_time} -> {updated_observed_time}"
        )
...
def check_search_reset_delegates(
    ...
    if isinstance(initial_observed_time, dict):
        ...
        # Non-panel case
        assert reset_observed_time != initial_observed_time, "observed_time should change after reset"
