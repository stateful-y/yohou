...
def test_two_component_additive_identity_linear_trend(linear_series):
...
@pytest.mark.integration
def test_two_component_additive_identity_constant_series():
    ...
    np.testing.assert_allclose(pred_values, 10.0, atol=1e-6, err_msg="Constant series should predict constant value")


@pytest.mark.integration
def test_multiplicative_decomposition_exponential_seasonal(exponential_series, seasonal_series):
    ...
    forecasters_dict = dict(pipeline.forecasters_)
    trend_pred = forecasters_dict["trend"].predict(forecasting_horizon=forecasting_horizon, predict_transformed=True)
...
@pytest.mark.integration
def test_multiplicative_two_component_simple():
...
@pytest.mark.integration
def test_three_component_decomposition_weekly_seasonality(trend_plus_seasonal):
...
@pytest.mark.integration
def test_three_component_decomposition_monthly_seasonality():
...
@pytest.mark.integration
def test_three_component_decomposition_daily_seasonality():
...
@pytest.mark.integration
def test_four_component_decomposition_quadratic_seasonal():
...
@pytest.mark.integration
def test_four_component_decomposition_sequential_residual_extraction():
...
@pytest.mark.integration
def test_component_specific_transformers_mixed():
...
@pytest.mark.integration
def test_component_specific_transformers_all_scaled():
...
@pytest.mark.integration
def test_component_specific_transformers_none():
...
@pytest.mark.integration
def test_different_horizons_fit3_predict10(linear_series):
...
@pytest.mark.integration
def test_different_horizons_fit20_predict5():
...
@pytest.mark.integration
def test_different_horizons_three_component():
...
@pytest.mark.integration
def test_observe_shifts_predictions_two_component(linear_series):
...
@pytest.mark.integration
def test_rewind_reverts_to_observation_horizon_state(linear_series):
...
@pytest.mark.integration
def test_observe_predict_atomic_two_component():
...
@pytest.mark.integration
def test_observe_rewind_three_component():
...
@pytest.mark.integration
def test_multiple_observes_cumulative_effect():
...
@pytest.mark.integration
def test_rewind_with_panel_group_names():
