...
@pytest.mark.integration
def test_level2_column_forecaster_with_pipelines(linear_series):
...
@pytest.mark.integration
def test_level2_column_forecaster_with_remainder(linear_series):
...
@pytest.mark.integration
def test_level2_column_forecaster_multi_column_assignment(linear_series):
...
@pytest.mark.integration
def test_level3_decomposition_inside_column_forecaster(linear_series):
...
@pytest.mark.integration
def test_level3_multiple_decompositions_in_columns(linear_series):
...
def test_level4_forecasted_feature_with_pipelines(linear_series, strategy, split_ratio):
...
@pytest.mark.integration
def test_level5_full_tower_get_params(full_tower_forecaster):
...
@pytest.mark.integration
def test_level5_full_tower_set_params(full_tower_forecaster):
...
@pytest.mark.integration
def test_level5_full_tower_clone(full_tower_forecaster):
...
@pytest.mark.integration
def test_level5_full_tower_fit_predict(full_tower_forecaster, linear_series):
...
@pytest.mark.integration
def test_level5_full_tower_observe_predict(full_tower_forecaster, linear_series):
