...
def test_split_conformal_with_distance_similarity(ar1_series, metric):
...
@pytest.mark.integration
def test_split_conformal_similarity_comparison_across_metrics(ar1_series):
...
def test_interval_reduction_with_coverage_rates(ar1_series, coverage_rates):
...
@pytest.mark.integration
def test_interval_reduction_different_horizon(ar1_series):
...
@pytest.mark.integration
def test_interval_reduction_with_feature_pipeline(ar1_series):
...
@pytest.mark.integration
def test_interval_reduction_observe_predict_interval(ar1_series):
...
@pytest.mark.integration
def test_column_forecaster_mixed_point_interval(linear_series):
...
@pytest.mark.integration
def test_column_forecaster_all_interval_forecasters(linear_series):
...
@pytest.mark.integration
def test_column_forecaster_interval_with_remainder(linear_series):
...
@pytest.mark.integration
def test_forecasted_feature_interval_target(ar1_series):
...
@pytest.mark.integration
def test_forecasted_feature_interval_observe_predict_interval(ar1_series):
...
def test_forecasted_feature_interval_with_strategies(ar1_series, strategy):
    ...
    forecaster = ForecastedFeatureForecaster(
        target_forecaster=SplitConformalForecaster(point_forecaster=SeasonalNaive(seasonality=1), calibration_size=30),
        feature_forecaster=PointReductionForecaster(LinearRegression(), feature_transformer=LagTransformer(lag=1)),
        strategy=strategy,
        split_ratio=0.8,
    )
...
@pytest.mark.integration
def test_forecasted_feature_interval_multiple_coverage_rates(ar1_series):
