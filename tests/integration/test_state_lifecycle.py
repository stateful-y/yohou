...
def test_state_machine_full_cycle(composition_factory, ar1_series):
...
@pytest.mark.integration
def test_state_machine_observation_buffer_growth(ar1_series):
...
@pytest.mark.integration
def test_state_machine_rewind_idempotency(ar1_series):
...
@pytest.mark.integration
def test_state_machine_observe_predict_equivalence(ar1_series):
...
@pytest.mark.integration
def test_state_machine_series_of_observes(ar1_series):
...
@pytest.mark.integration
def test_predict_idempotency(ar1_series):
...
@pytest.mark.integration
def test_predict_interval_idempotency(ar1_series):
...
@pytest.mark.integration
def test_fit_idempotency(ar1_series):
...
@pytest.mark.integration
def test_observe_empty_dataframe(ar1_series):
...
@pytest.mark.integration
def test_memory_bounded_feature_pipeline(ar1_series):
...
@pytest.mark.integration
def test_memory_bounded_feature_union(ar1_series):
...
@pytest.mark.integration
def test_memory_bounded_column_transformer(ar1_series):
...
@pytest.mark.integration
def test_clone_is_unfitted(ar1_series):
...
@pytest.mark.integration
def test_clone_predict_raises_error(ar1_series):
...
@pytest.mark.integration
def test_clone_fit_independence(ar1_series):
...
def test_pickle_round_trip(composition_factory, ar1_series):
...
def test_sequential_observe_predict_convergence(ar1_series, phi):
...
@pytest.mark.integration
def test_sequential_observe_predict_no_memory_leak(ar1_series):
...
@pytest.mark.integration
def test_deep_pipeline_memory_bounded(ar1_series):
...
@pytest.mark.integration
def test_column_forecaster_nested_state(ar1_series):
...
@pytest.mark.integration
def test_decomposition_pipeline_state_isolation(ar1_series):
...
@pytest.mark.integration
def test_state_transition_with_varying_horizons(ar1_series):
...
@pytest.mark.integration
def test_state_after_failed_observe(ar1_series):
...
@pytest.mark.integration
def test_state_rewind_to_different_lengths(ar1_series):
