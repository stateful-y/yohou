...
def test_check_panel_data(y_X_factory):
...
def test_check_panel_data_non_panel(y_X_factory):
...
def test_check_panel_single_group(y_X_factory):
...
def test_check_panel_invalid_group_raises(y_X_factory):
