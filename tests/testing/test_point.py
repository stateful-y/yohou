...
def test_check_point_prediction_structure(y_X_factory):
...
def test_check_point_prediction_structure_different_horizon(y_X_factory):
...
def test_check_point_prediction_types():
...
def test_check_point_prediction_types_fails_for_wrong_type():
