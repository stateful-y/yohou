...
def test_update_predict_global(fit_forecasting_horizon, predict_forecasting_horizon, stride, expected_a):
    forecaster = PointReductionForecaster()
...
def test_dtype_preservation_single_column():
...
def test_dtype_preservation_multiple_columns():
...
def test_dtype_preservation_with_transformer():
...
def test_dtype_preservation_int16_to_int64():
