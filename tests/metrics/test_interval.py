...
# ============================================================================
# Systematic Checks for All Interval Scorers
# ============================================================================


def test_empirical_coverage_systematic(perfect_interval_predictions):
...
def test_mean_interval_width_systematic(perfect_interval_predictions):
...
def test_interval_score_systematic(perfect_interval_predictions):
...
def test_pinball_loss_systematic(perfect_interval_predictions):
...
def test_calibration_error_systematic(multi_rate_predictions):
...
def test_empirical_coverage_perfect_coverage(perfect_interval_predictions):
...
def test_empirical_coverage_zero_coverage(zero_coverage_predictions):
...
def test_empirical_coverage_per_rate_via_aggregation(multi_rate_predictions):
...
def test_empirical_coverage_per_step(perfect_interval_predictions):
...
def test_empirical_coverage_per_step_and_per_rate(multi_rate_predictions):
...
def test_empirical_coverage_sklearn_tags():
...
def test_mean_interval_width_known_width():
...
def test_mean_interval_width_absolute_width():
...
def test_mean_interval_width_per_rate_via_aggregation(multi_rate_predictions):
    """Test aggregation without "coveragewise" returns dict with rate keys."""
    y_true, y_pred = multi_rate_predictions
...
def test_mean_interval_width_per_step():
...
def test_interval_score_perfect_predictions_equals_width(perfect_interval_predictions):
...
def test_interval_score_penalty_for_under_coverage():
...
def test_interval_score_per_step():
    """Test aggregation_method=['componentwise', 'coveragewise'] returns DataFrame."""
    y_true = pl.DataFrame({
        "time": [datetime(2020, 1, 1), datetime(2020, 1, 2)],
        "value": [10.0, 20.0],
...
def test_pinball_loss_perfect_predictions_zero_loss():
...
def test_pinball_loss_per_step():
    """Test aggregation_method=['componentwise', 'coveragewise'] returns DataFrame."""
    y_true = pl.DataFrame({
        "time": [datetime(2020, 1, 1), datetime(2020, 1, 2)],
        "value": [10.0, 20.0],
...
def test_calibration_error_requires_multiple_rates():
...
def test_calibration_error_perfect_calibration(multi_rate_predictions):
...
def test_calibration_error_per_step(multi_rate_predictions):
    """Test aggregation_method=['componentwise', 'coveragewise'] returns DataFrame."""
    y_true, y_pred = multi_rate_predictions
...
def test_panel_data_coverage_with_panel_data():
...
def test_edge_cases_single_step_prediction():
...
def test_edge_cases_multiple_columns():
