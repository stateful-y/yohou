...
def _(mo):
    mo.md(
        ...
        **Prerequisites:** Familiarity with `X_actual`, `X_future`,
        ...
        ([Tutorial](/examples/compose/exogenous_features/)).
        """
    )
...
@app.cell
def _(forecaster, last_obs, np, predictions, vintages):
...
def _(mo):
    mo.md(
        ...
        **See also:**
        [About Exogenous Features](/pages/explanation/exogenous-features/) ·
