...
__gallery__ = {
    ...
    "api_references": ["AbsoluteResidual", "EmpiricalCoverage", "GammaResidual", "IntervalScore", "MeanIntervalWidth", "PointReductionForecaster", "Residual", "SeasonalNaive", "SplitConformalForecaster", "plot_score_per_vintage", "plot_score_time_series"],
}
