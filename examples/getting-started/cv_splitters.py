...
__gallery__ = {
    ...
    "companion": "/pages/tutorials/cross-validation-splitters/",
    "api_references": ["plot_splits"],
}
...
def _(mo):
    ...
    - **Hyperparameter search**: See the [Forecasting Workflow](/pages/tutorials/forecasting-workflow/) tutorial for using splitters inside GridSearchCV
    - **Conceptual background**: See [Model Selection](/pages/explanation/model-selection/) for expanding vs. sliding windows and fold design
    """)
