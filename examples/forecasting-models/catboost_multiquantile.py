...
__gallery__ = {
    ...
    "api_references": ["EmpiricalCoverage", "IntervalReductionForecaster", "IntervalScore", "MeanIntervalWidth", "plot_score_per_step", "plot_score_per_vintage"],
}
...
def _(mo):
    ...
    **Prerequisites:** Familiarity with [`IntervalReductionForecaster`](/pages/api/generated/yohou.interval.reduction.IntervalReductionForecaster/).
    """)
