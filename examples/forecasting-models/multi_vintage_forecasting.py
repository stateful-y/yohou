...
__gallery__ = {
    ...
    "category": "how-to",
    "companion": "/pages/how-to/forecast-vintages/",
...
def _(
    ...
    y_train, _, X_actual_train, _ = train_test_split(
        y, X_actual, test_size=len(y) - 250
    )
...
def _(mo):
    mo.md(
        ...
        - [How to Use Exogenous Features](/pages/how-to/exogenous-features/) for the full guide
        - [Exogenous Features tutorial](/pages/tutorials/exogenous-features/) for a step-by-step walkthrough
