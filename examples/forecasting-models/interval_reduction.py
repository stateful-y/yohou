...
__gallery__ = {
    ...
    "api_references": ["EmpiricalCoverage", "IntervalReductionForecaster", "IntervalScore", "MeanIntervalWidth", "plot_score_heatmap", "plot_score_per_vintage"],
}
...
def _(mo):
    ...
    **Prerequisites:** Understanding of [`PointReductionForecaster`](/pages/api/generated/yohou.point.reduction.PointReductionForecaster/) and prediction intervals.
    """)
