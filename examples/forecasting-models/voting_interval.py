...
__gallery__ = {
    ...
    "api_references": ["PointReductionForecaster", "SeasonalNaive", "SplitConformalForecaster", "VotingIntervalForecaster"],
}
...
def _(mo):
    ...
    Wrap different point forecasters in [`SplitConformalForecaster`](/pages/api/generated/yohou.interval.split_conformal.SplitConformalForecaster/) to
...
def _(mo):
    ...
    [`VotingIntervalForecaster`](/pages/api/generated/yohou.ensemble.voting_interval.VotingIntervalForecaster/) exposes a `predict()` method.
...
def _(mo):
    mo.md(
        ...
        - [Interval Forecasting Tutorial](/pages/tutorials/interval-forecasting/) for related techniques
        """
    )
    return
