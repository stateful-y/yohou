...
__gallery__ = {
    "title": "How to Use Distance-Based Similarity for Intervals",
    ...
    "api_references": ["AbsoluteResidual", "DistanceSimilarity", "IntervalScore", "MeanIntervalWidth", "PointReductionForecaster", "SplitConformalForecaster", "plot_calibration", "plot_score_heatmap", "plot_score_per_step", "plot_score_per_vintage"],
}
...
def _(mo):
    ...
    **Prerequisites:** Familiarity with [`SplitConformalForecaster`](/pages/api/generated/yohou.interval.split_conformal.SplitConformalForecaster/) and basic conformal prediction.
    """)
