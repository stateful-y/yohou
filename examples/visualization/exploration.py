...
__gallery__ = {
    ...
    "description": "Exploratory time series visualisation with raw series plots, rolling statistics overlays, seasonal overlays, subseries diagnostics, distribution boxplots, missing data pattern auditing, outlier detection, and resampling comparison.",
    "category": "tutorial",
    "companion": "/pages/tutorials/exploratory-visualization/",
    "section": "visualization",
    "api_references": ["plot_boxplot", "plot_distribution", "plot_missing_data", "plot_outliers", "plot_resampling_comparison", "plot_rolling_statistics", "plot_seasonality", "plot_subseasonality"],
}
...
def _(mo):
    ...
    [`plot_seasonality`](/pages/api/generated/yohou.plotting.diagnostics.plot_seasonality/) overlays one line per cycle (e.g. one line per year) on the
    same seasonal axis. This makes it easy to compare how the same season
...
def _(plot_seasonality, tourism_monthly):
    plot_seasonality(
        tourism_monthly,
        seasonality="month",
        title="Monthly Seasonal Overlay (Tourism)",
    )
...
def _(plot_seasonality, tourism_monthly):
    plot_seasonality(
        tourism_monthly,
        seasonality="quarter",
        title="Quarterly Seasonal Overlay (Tourism)",
    )
...
def _(plot_seasonality, tourism_quarterly):
    plot_seasonality(
        ...
        seasonality="month",
        groups=["T1", "T2"],
        title="Seasonal Overlay - Panel (T1 & T2)",
    )
...
def _(mo):
    mo.md(r"""
    ## 4. Seasonal Subseries

    [`plot_subseasonality`](/pages/api/generated/yohou.plotting.diagnostics.plot_subseasonality/) creates one mini subplot per season (e.g. 12 for
    months). Within each subplot the values for that season across all cycles
    are connected chronologically, with an optional horizontal mean line.
    """)
...
def _(plot_subseasonality, tourism_monthly):
    plot_subseasonality(
        ...
        seasonality="month",
        kind="mean",
        title="Monthly Subseries with Mean (Tourism)",
    )
...
def _(plot_subseasonality, tourism_monthly):
    plot_subseasonality(
        ...
        seasonality="month",
        kind="box",
        title="Monthly Subseries - Box (Tourism)",
    )
...
def _(plot_subseasonality, tourism_monthly):
    plot_subseasonality(
        ...
        seasonality="quarter",
        kind="violin",
        title="Quarterly Subseries - Violin (Tourism)",
    )
...
def _(mo):
    mo.md(
        ...
        - [Exploratory Visualization](/pages/tutorials/exploratory-visualization/) for the full guide
