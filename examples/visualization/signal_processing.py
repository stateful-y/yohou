...
__gallery__ = {
    "title": "How to Visualize Signal Processing",
    ...
    "companion": "/pages/how-to/apply-signal-processing/",
    "api_references": ["NumericalFilter", "plot_phase", "plot_spectrum"],
}
...
def _(mo):
    mo.md(r"""
    ## 5. Higher-Order and Bandpass Filters
...
def _(mo):
    mo.md(
        ...
        - [Apply Signal Processing](/pages/how-to/apply-signal-processing/) for the full guide
