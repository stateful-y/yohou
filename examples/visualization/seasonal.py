...
__gallery__ = {
    ...
    "category": "tutorial",
    "companion": "/pages/tutorials/seasonal-analysis/",
    "section": "visualization",
    "api_references": ["plot_autocorrelation", "plot_decomposition", "plot_partial_autocorrelation", "plot_seasonal_heatmap", "plot_seasonality", "plot_subseasonality"],
}
...
def _(mo):
    mo.md(
        ...
        - [Seasonal Analysis](/pages/tutorials/seasonal-analysis/) for the full guide
