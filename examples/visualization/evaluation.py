...
__gallery__ = {
    ...
    "api_references": ["MeanAbsolutePercentageError", "PointReductionForecaster", "SeasonalNaive", "SplitConformalForecaster", "plot_calibration", "plot_group_scores", "plot_residuals", "plot_score_distribution", "plot_score_heatmap", "plot_score_per_step", "plot_score_per_vintage", "plot_score_summary", "plot_score_time_series"],
}
...
def _(mo):
    ...
    **Prerequisites:** Familiarity with yohou's fit/predict API and scoring system (see
...
def _(mo):
    ...
    - **Forecasting**: See [`examples/visualization/forecasting_visualization.py`](/examples/forecasting_visualization/) for forecast plots, intervals, and comparison modes
    - **Cross-validation**: See [`examples/visualization/model_selection.py`](/examples/model_selection/) for train/test split visualization
