...
def _(mo):
    ...
    `plot_score_per_step` shows how accuracy degrades across the forecast window.
    """)
...
def _(mo):
    ...
    `plot_score_per_vintage` tracks accuracy over successive forecast origins.
...
def _(mo):
    ...
    `plot_score_heatmap` combines both dimensions into a single view.
