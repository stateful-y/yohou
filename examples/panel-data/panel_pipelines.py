...
__gallery__ = {
    "title": "How to Build Panel Feature Pipelines",
    ...
    "category": "how-to",
    "section": "panel-data",
    "companion": "/pages/how-to/compose-feature-pipelines/",
    "api_references": ["ColumnForecaster", "DecompositionPipeline", "FeaturePipeline", "FeatureUnion", "PatternSeasonalityForecaster", "PointReductionForecaster", "PolynomialTrendForecaster", "RollingStatisticsTransformer", "SeasonalNaive"],
}
...
def _(mo):
    mo.md(
        ...
        - [Compose Feature Pipelines](/pages/how-to/compose-feature-pipelines/) for the full guide
