...
__gallery__ = {
    "title": "How to Run Panel Cross-Validation",
    ...
    "api_references": ["fetch_tourism_quarterly", "plot_time_series", "GridSearchCV", "ExpandingWindowSplitter", "LagTransformer", "PointReductionForecaster", "MeanAbsoluteError", "plot_forecast"],
}
