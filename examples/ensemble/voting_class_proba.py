...
def _(mo):
    ...
    Familiarity with class-probability forecasting. See the
    [Class-Probability Forecasting Quickstart](/examples/class_proba/class_proba_forecaster/).
    """)
...
def _(mo):
    ...
    Create diverse classifiers wrapped in `ClassProbaReductionForecaster`.
    """)
...
def _(mo):
    ...
    Pass the named forecasters to `VotingClassProbaForecaster` with `method="soft"`.
...
def _(mo):
    ...
    Evaluate all three strategies with `LogLoss`, `BrierScore`, and `Accuracy`.
    """)
