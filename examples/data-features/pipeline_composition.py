...
__gallery__ = {
    "title": "How to Build a Feature Pipeline",
    ...
    "api_references": ["DecompositionPipeline", "FeaturePipeline", "FeatureUnion", "PointReductionForecaster", "PolynomialTrendForecaster", "RollingStatisticsTransformer", "SeasonalNaive"],
}
...
def _(mo):
    mo.md(
        ...
        - [Use Preprocessing Transformers](/pages/how-to/use-preprocessing-transformers/) for related techniques
        """
    )
    return
