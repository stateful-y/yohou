...
__gallery__ = {
    "title": "How to Clean Time Series Data",
    ...
    "category": "how-to",
    "companion": "/pages/how-to/clean-and-resample/",
    "section": "data-features",
    "api_references": ["FeaturePipeline", "OutlierPercentileHandler", "OutlierThresholdHandler", "SeasonalImputer", "SimpleTimeImputer", "plot_missing_data"],
}
...
def _(mo):
    mo.md(
        ...
        - [Clean and Resample Time Series](/pages/how-to/clean-and-resample/) for the full guide
        - [Handle Missing Data](/pages/how-to/handle-missing-data/) for related techniques
        """
    )
    return
