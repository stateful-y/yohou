...
__gallery__ = {
    "title": "How to Wrap Functions as Transformers",
    ...
    "api_references": ["FunctionTransformer", "PointReductionForecaster", "plot_score_time_series"],
}
...
def _(mo):
    ...
    **Prerequisites:** Working knowledge of polars expressions and [`PointReductionForecaster`](/pages/api/generated/yohou.point.reduction.PointReductionForecaster/)
...
def _(mo):
    ...
    [`train_test_split`](/pages/api/generated/yohou.model_selection.split.train_test_split/) preserves temporal order, which is
...
def _(mo):
    ...
    The function receives a polars [`DataFrame`](https://docs.pola.rs/api/python/stable/reference/dataframe/index.html) **without the `"time"` column**
