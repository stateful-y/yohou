...
__gallery__ = {
    "title": "How to Apply Stationarity Transforms",
    ...
    "api_references": ["ASinhTransformer", "AbsoluteSeasonalReturn", "BoxCoxTransformer", "LogTransformer", "SeasonalDifferencing", "SeasonalLogDifferencing", "SeasonalReturn"],
}
