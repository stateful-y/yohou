...
__gallery__ = {
    "title": "How to Use ColumnTransformer",
    ...
    "api_references": ["ColumnTransformer", "PointReductionForecaster"],
}
...
def _(mo):
    mo.md(
        ...
        - [Use Preprocessing Transformers](/pages/how-to/use-preprocessing-transformers/) for the full guide
