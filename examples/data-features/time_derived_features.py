...
__gallery__ = {
    ...
    "api_references": ["CalendarFeatureTransformer", "FeatureUnion", "FourierFeatureTransformer", "HolidayFeatureTransformer", "TimeIndexTransformer"],
}
...
def _(mo):
    ...
    **Prerequisites:** Basic understanding of time series feature engineering and Fourier series.
    """)
...
def _(mo):
    ...
    periods. Each [`FourierFeatureTransformer`](/pages/api/generated/yohou.preprocessing.time_features.FourierFeatureTransformer/) handles one seasonal period,
...
def _(mo):
    ...
    - **Using in forecasters**: Pass to `actual_transformer` in [`PointReductionForecaster`](/pages/api/generated/yohou.point.reduction.PointReductionForecaster/)
    """)
