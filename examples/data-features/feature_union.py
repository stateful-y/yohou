...
__gallery__ = {
    "title": "How to Compose Features with FeatureUnion",
    ...
    "api_references": ["ExponentialMovingAverage", "FeatureUnion", "PointReductionForecaster", "RollingStatisticsTransformer", "SeasonalNaive"],
}
