...
__gallery__ = {
    "title": "How to Apply Signal Processing Filters",
    ...
    "api_references": ["NumericalDifferentiator", "NumericalFilter", "NumericalIntegrator"],
}
...
def _(mo):
    mo.md(
        ...
        - [Apply Signal Processing Filters](/pages/how-to/apply-signal-processing/) for the full guide
