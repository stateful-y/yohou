...
__gallery__ = {
    "title": "How to Search Interval Forecaster Hyperparameters",
    ...
    "api_references": ["AbsoluteResidual", "EmpiricalCoverage", "GridSearchCV", "IntervalScore", "MeanIntervalWidth", "PointReductionForecaster", "Residual", "SplitConformalForecaster"],
}
...
def _(fetch_sunspot, mo, pl):
    ...
    n_test = 24
    y_train, y_test = train_test_split(ss, test_size=n_test)
    horizon = n_test
...
def _(mo):
    ...
    to [`GridSearchCV`](/pages/api/generated/yohou.model_selection.search.GridSearchCV/). The search automatically:
...
def _(mo):
    ...
    The search used [`IntervalScore`](/pages/api/generated/yohou.metrics.interval.IntervalScore/) to rank parameters. Lower (more negative)
...
def _(mo):
    ...
    [`GridSearchCV`](/pages/api/generated/yohou.model_selection.search.GridSearchCV/) handles this transparently:
...
def _(mo):
    mo.md(
        ...
        - [Interval Forecasting](/pages/how-to/interval-forecasting/) for the full guide
