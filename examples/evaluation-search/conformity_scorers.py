...
__gallery__ = {
    "title": "How to Use Conformity Scorers",
    ...
    "api_references": ["AbsoluteGammaResidual", "AbsoluteResidual", "DistanceSimilarity", "EmpiricalCoverage", "GammaResidual", "IntervalScore", "MeanIntervalWidth", "Residual", "SplitConformalForecaster", "plot_score_per_step", "plot_score_time_series"],
}
...
def _(mo):
    ...
    **Prerequisites:** Familiarity with [`SplitConformalForecaster`](/pages/api/generated/yohou.interval.split_conformal.SplitConformalForecaster/).
    """)
