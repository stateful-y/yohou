...
__gallery__ = {
    "title": "How to Evaluate Interval Forecasts",
    ...
    "api_references": ["CalibrationError", "EmpiricalCoverage", "IntervalReductionForecaster", "IntervalScore", "MeanIntervalWidth", "PinballLoss", "plot_calibration", "plot_score_heatmap", "plot_score_per_vintage", "plot_score_time_series"],
}
