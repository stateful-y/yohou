...
__gallery__ = {
    "title": "How to Search with Multiple Metrics",
...
def _(mo):
    ...
    Pass a dict of [`BaseScorer`](/pages/api/generated/yohou.metrics.base.BaseScorer/) instances. When using a dict, `refit`
