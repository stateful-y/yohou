...
__gallery__ = {
    ...
    "api_references": ["Accuracy", "MeanAbsolutePercentageError", "MeanAbsoluteScaledError", "MeanSquaredError", "MedianAbsoluteError", "PointReductionForecaster", "RootMeanSquaredScaledError", "SeasonalNaive", "SymmetricMeanAbsolutePercentageError", "plot_score_per_vintage", "plot_score_summary", "plot_score_time_series"],
}
...
def _(mo):
    ...
    **Prerequisites:** Basic understanding of forecast error metrics.
    """)
...
def _(mo):
    ...
    baseline and a [`PointReductionForecaster`](/pages/api/generated/yohou.point.reduction.PointReductionForecaster/) with a [`Ridge`](https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.Ridge.html) regressor. Both
...
def _(mo):
    ...
    [`plot_forecast`](/pages/api/generated/yohou.plotting.forecasting.plot_forecast/) auto-detects categorical columns and renders a step chart.
