...
__gallery__ = {
    "title": "How to Run Hyperparameter Search",
    ...
    "companion": "/pages/how-to/tune-hyperparameters/",
    "api_references": ["ClassProbaReductionForecaster", "GridSearchCV", "PointReductionForecaster", "RandomizedSearchCV", "plot_cv_results_scatter", "plot_score_per_step"],
}
...
def _(mo):
    ...
    **Prerequisites:** Familiarity with splitters (see `cv_splitters.py`) and scorers (see `metrics/`).
    """)
