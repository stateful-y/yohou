...
-  **Get Started in 5 Minutes**
    ...
    Install Yohou and [achieve first result]
...
Step-by-step guide to installing and setting up Yohou in your project.
...
A practical example demonstrating how to use Yohou in a real project.
