...
[`plot_time_series`](/pages/api/generated/yohou.plotting.plot_time_series/) is the starting point: a line chart of raw observations
over time with support for multiple columns and categorical series rendered as
step lines with markers.
[`plot_rolling_statistics`](/pages/api/generated/yohou.plotting.plot_rolling_statistics/) exposes two critical properties at once:
...
[`plot_boxplot`](/pages/api/generated/yohou.plotting.plot_boxplot/) grouped by period reveals whether seasonal variation is
additive (constant box height across years) or multiplicative (box height grows
with the level).
[`plot_missing_data`](/pages/api/generated/yohou.plotting.plot_missing_data/) renders a heatmap that distinguishes between scattered
gaps (typically safe to interpolate) and contiguous blocks (which may require
truncating the series).
[`plot_outliers`](/pages/api/generated/yohou.plotting.plot_outliers/) flags observations worth investigating via IQR or
...
errors.
[`plot_distribution`](/pages/api/generated/yohou.plotting.plot_distribution/) shows histograms with KDE overlays for examining
value distributions, and
[`plot_resampling_comparison`](/pages/api/generated/yohou.plotting.plot_resampling_comparison/) overlays the same series at different
...
[`plot_autocorrelation`](/pages/api/generated/yohou.plotting.plot_autocorrelation/) confirms periodicity: a significant spike at lag
12 in monthly data confirms yearly seasonality, while slow decay across many
lags suggests the series needs differencing.
[`plot_partial_autocorrelation`](/pages/api/generated/yohou.plotting.plot_partial_autocorrelation/) isolates direct dependence at each
...
[`plot_seasonality`](/pages/api/generated/yohou.plotting.plot_seasonality/) overlays values by seasonal period, and
[`plot_subseasonality`](/pages/api/generated/yohou.plotting.plot_subseasonality/) reveals within-period patterns (e.g., day-of-week
within each month).
[`plot_seasonal_heatmap`](/pages/api/generated/yohou.plotting.plot_seasonal_heatmap/) renders values on a two-dimensional
period-by-cycle grid.
Together, these reveal whether the seasonal pattern is stable across years
(pointing to [`PatternSeasonalityForecaster`](/pages/api/generated/yohou.stationarity.PatternSeasonalityForecaster/))
or evolving (pointing to Fourier features or adaptive approaches).

[`plot_correlation_heatmap`](/pages/api/generated/yohou.plotting.plot_correlation_heatmap/) shows pairwise Pearson correlation across columns.
[`plot_lag_scatter`](/pages/api/generated/yohou.plotting.plot_lag_scatter/) plots `y(t)` against `y(t-k)` to visually check lag
relationships, while [`plot_scatter_matrix`](/pages/api/generated/yohou.plotting.plot_scatter_matrix/) shows all pairwise scatter
plots in a grid.
[`plot_cross_correlation`](/pages/api/generated/yohou.plotting.plot_cross_correlation/) measures the lagged relationship between two
different series, which is useful for identifying leading indicators or exogenous
feature lags.

### Spectral Analysis

[`plot_spectrum`](/pages/api/generated/yohou.plotting.plot_spectrum/) shows the power spectral density of a series via the
periodogram. Peaks at specific frequencies identify dominant periodicities that
might not be obvious in the time domain. [`plot_phase`](/pages/api/generated/yohou.plotting.plot_phase/) displays the phase angle
...
[`plot_forecast`](/pages/api/generated/yohou.plotting.plot_forecast/) overlays predicted values against actuals with optional
...
[`plot_decomposition`](/pages/api/generated/yohou.plotting.plot_decomposition/) displays the individual components of a decomposed
...
[`plot_time_weight`](/pages/api/generated/yohou.plotting.plot_time_weight/) visualizes how the weighting function emphasized
...
[`plot_residuals`](/pages/api/generated/yohou.plotting.plot_residuals/) renders a four-panel diagnostic layout when given a
...
heteroscedasticity.
[`plot_calibration`](/pages/api/generated/yohou.plotting.plot_calibration/) checks whether prediction intervals achieve their
...
[`plot_score_time_series`](/pages/api/generated/yohou.plotting.plot_score_time_series/) shows how a metric evolves over time,
[`plot_score_distribution`](/pages/api/generated/yohou.plotting.plot_score_distribution/) shows its histogram,
[`plot_score_summary`](/pages/api/generated/yohou.plotting.plot_score_summary/) renders a grouped bar chart of aggregate scores
for quick model comparison,
[`plot_score_per_step`](/pages/api/generated/yohou.plotting.plot_score_per_step/) reveals how accuracy degrades across the forecast
horizon (important for choosing between multi-output, direct, and dir-rec
reduction strategies),
[`plot_score_per_vintage`](/pages/api/generated/yohou.plotting.plot_score_per_vintage/) tracks performance across cross-validation
vintages for hindsight analysis,
[`plot_score_heatmap`](/pages/api/generated/yohou.plotting.plot_score_heatmap/) produces a two-dimensional aggregation grid, and
[`plot_group_scores`](/pages/api/generated/yohou.plotting.plot_group_scores/) compares panel groups or members directly.

### Cross-Validation and Search

[`plot_splits`](/pages/api/generated/yohou.plotting.plot_splits/) visualizes the train/test segments of a
[`BaseSplitter`](/pages/api/generated/yohou.model_selection.BaseSplitter/) as a
timeline, confirming that temporal ordering is preserved across folds.
[`plot_cv_results_scatter`](/pages/api/generated/yohou.plotting.plot_cv_results_scatter/) connects hyperparameter values to
...
`apply_default_layout` utility standardizes appearance: the
...
[`palette_yohou`](/pages/api/generated/yohou.plotting.palette_yohou/): blue, red, green, purple, orange, pink, yellow,
...
[`set_config`](/pages/api/generated/yohou.plotting.set_config/) function enables
...
per call. The [`config_context`](/pages/api/generated/yohou.plotting.config_context/) context manager temporarily changes the
...
`line_shape` through [`set_config`](/pages/api/generated/yohou.plotting.set_config/) forces every scatter line trace,
across the time-axis plotting functions and faceted subplots, to use that
interpolation. The accepted values are listed in `VALID_LINE_SHAPES`: `"hv"` and
...
series are exempt: [`plot_calibration`](/pages/api/generated/yohou.plotting.plot_calibration/) keeps its reliability curve and
...
[`config_context`](/pages/api/generated/yohou.plotting.config_context/) applies the shape for a single block and restores the
