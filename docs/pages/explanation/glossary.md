...
:   The double-underscore (`__`) separator between a panel group name and a column
    name. For example, `store_A__sales` identifies column `sales` in group `store_A`.
...
:   A [`BaseTransformer`](/pages/api/generated/yohou.base.BaseTransformer/)
