...
- [Preprocessing](preprocessing.md): Stateful vs. stateless transformers, the [`BaseTransformer`](/pages/api/generated/yohou.base.BaseTransformer/) contract, and incremental observation in pipelines.
