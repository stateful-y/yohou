...
[`BaseActualTransformer`](/pages/api/generated/yohou.base.transformer.BaseActualTransformer/) can implement temporal logic with a fixed lookback window that the
...
[`BaseActualTransformer`](/pages/api/generated/yohou.base.transformer.BaseActualTransformer/) extends sklearn's transformer protocol with:
