---
description: How to cite Yohou, in plain text and in BibTeX.
---
...
The version you used is the one `pip show yohou` reports.

## Machine-readable metadata

The repository root carries a
[`CITATION.cff`](https://github.com/stateful-y/yohou/blob/main/CITATION.cff)
...
No release of Yohou has been deposited with a DOI-issuing archive, so
