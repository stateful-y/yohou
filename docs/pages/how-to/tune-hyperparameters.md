...
- [Early Stop Inside a Search](early-stopping.md#8-early-stop-inside-a-search): stop boosting estimators on each fold's test window with `validation="cv"` and refit with the chosen iteration count
